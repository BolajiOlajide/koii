...
exports.getUniqueRoutes = function (routerObject) {
  ...
  routerObject.forEach(function(obj) { // eslint-disable-line
    if (!obj.route) {
      return;
    }
...
exports.validateApplication = function (app) {
  if (!app) {
    ...
    const messageTwo = 'Ensure you\'re making use of Koi within an express application';
...
exports.formatRoutes = function (routes) {
  ...
  routes.forEach(function (route) { // eslint-disable-line prefer-arrow-callback
